...
#TODO: add param for decays and others
...
#fetch approprite base model
if "ssd-mobilenet-v2-coco" in params['model']:
	if 'epochs' not in params:
		params['epochs'] = 15000
	os.system("python /onepanel/code/create_pipeline_v2.py -in_pipeline /onepanel/input/datasets/{}/{}/{}/pipeline.config -num_classes {} -epochs {} -model /onepanel/input/datasets/{}/{}/{}/model.ckpt -label {}/label_map.pbtxt -train_data {}/training.tfrecord -eval_data {}/training.tfrecord -out_pipeline /onepanel/output/pipeline.config -num_clones {}".format(params['model_uid'],params['model_path'],params['model_version'],params["num_classes"], params["epochs"],params['model_uid'],params['model_path'],params['model_version'], params["dataset"], params["dataset"], params["dataset"], params["num_clones"]))
...
#train and generate the frozen graph
...
#create onepanel dataset for output files

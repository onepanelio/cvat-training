#source: https://raw.githubusercontent.com/svpino/tf_object_detection_cm/master/confusion_matrix.py
...
flags.DEFINE_float('confidence_threshold', 0.5, 'confidence threshold')
